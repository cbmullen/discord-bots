...
export function handleSlashCommand(interaction) {
  ...
  const responses = [
    ...
    "Without a doubt", "Better not tell you now", "My sources say no", "Yes definitely", "Cannot predict now", "Outlook not so good", 
  ...
  return new Response(JSON.stringify(SendEphemeralMessage(`_${question}_ ... **${response}**`)), {
